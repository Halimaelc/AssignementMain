...
import ma.octo.assignement.service.AutiServiceVirement;
...
class VirementController {
    ...
    @Autowired
    private AutiServiceVirement monservice;
    @Autowired
    ...
    public void createTransaction(@RequestBody VirementDto virementDto)
        ...
        Compte f12 = rep1.findByNrCompte(virementDto.getNrCompteBeneficiaire());
        ...
        if (virementDto.getMontantVirement()==0.0) {
        ...
        if (c1.getSolde() - virementDto.getMontantVirement() < 0) {
            LOGGER.error("Solde insuffisant pour l'utilisateur");
        }

        c1.setSolde(c1.getSolde()-virementDto.getMontantVirement());
        rep1.save(c1);

        f12.setSolde((f12.getSolde() + virementDto.getMontantVirement()));
        rep1.save(f12);
        ...
        monservice.auditVirementString("Virement depuis " + virementDto.getNrCompteEmetteur() + " vers " + virementDto
